...
Write a function called convertArrayLikeObject which accepts a single parameter, an array like object. The function should return the array 
...
Write a function called displayEvenArguments which accepts a variable number of arguments and returns a new array with all of the arguments 
...
function displayEvenArguments(...arr) {
    return Array.from(arr).filter((x) => (x % 2 === 0));
}